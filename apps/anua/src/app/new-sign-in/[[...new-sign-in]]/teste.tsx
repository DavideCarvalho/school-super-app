          ...
          <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
            <SignIn.Step name="start">
              ...
              <Clerk.Field name="identifier">
                <Clerk.Label className="block text-sm font-medium leading-6 text-gray-900">
                  Email
                </Clerk.Label>
                <Clerk.Input className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                <Clerk.FieldError />
              </Clerk.Field>
            ...
            <SignIn.Step name="verifications">
              <SignIn.Strategy name="email_code">
                ...
                <p>
                  Enviamos um código para <SignIn.SafeIdentifier />.
                </p>
