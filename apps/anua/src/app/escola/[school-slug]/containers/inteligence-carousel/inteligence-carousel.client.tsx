  ...
  return (
    <Carousel>
      <CarouselContent>
          ...
          <CarouselItem className="md:basis-1/2 lg:basis-1/3">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium">Impressão</CardTitle>
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground">
                  {printRequestsNotApprovedCloseToDueDate.length === 1
                    ? "Está em risco de não ser impressas a tempo"
        ...
        {printRequestsToPrintToday && printRequestsToPrintToday?.length > 0 ? (
          <CarouselItem className="md:basis-1/2 lg:basis-1/3">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium">Impressão</CardTitle>
